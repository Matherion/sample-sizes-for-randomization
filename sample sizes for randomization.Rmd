...
```{r}
  ...
  dat$originalProbNonequivalence_d.2_1nvar <- 1-pdMild(.2, dat$originalSampleSize)^1;
  dat$originalProbNonequivalence_d.2_10nvar <- 1-pdMild(.2, dat$originalSampleSize)^10;
  dat$originalProbNonequivalence_d.2_100nvar <- 1-pdMild(.2, dat$originalSampleSize)^100;
  dat$originalProbNonequivalence_d.5_1nvar <- 1-pdMild(.5, dat$originalSampleSize)^1;
  dat$originalProbNonequivalence_d.5_10nvar <- 1-pdMild(.5, dat$originalSampleSize)^10;
  dat$originalProbNonequivalence_d.5_100nvar <- 1-pdMild(.5, dat$originalSampleSize)^100;

  dat$replicationProbNonequivalence_d.2_1nvar <- 1-pdMild(.2, dat$replicationSampleSize)^1;
  dat$replicationProbNonequivalence_d.2_10nvar <- 1-pdMild(.2, dat$replicationSampleSize)^10;
  dat$replicationProbNonequivalence_d.2_100nvar <- 1-pdMild(.2, dat$replicationSampleSize)^100;
  dat$replicationProbNonequivalence_d.5_1nvar <- 1-pdMild(.5, dat$replicationSampleSize)^1;
  dat$replicationProbNonequivalence_d.5_10nvar <- 1-pdMild(.5, dat$replicationSampleSize)^10;
  dat$replicationProbNonequivalence_d.5_100nvar <- 1-pdMild(.5, dat$replicationSampleSize)^100;
