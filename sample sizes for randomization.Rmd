...
```{r tab.cap="Required sample size to achieve 99%, 95%, 90%, and 80% likelihood of randomization success, with non-equivalence defined as group differences exceeding Cohen's d = .1, .2, .3, .4 and .5, and assuming one, ten, or a hundred nuisance variables exist." }
